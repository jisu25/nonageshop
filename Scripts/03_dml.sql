...
insert into cart(MEMBER_ID, PRODUCT_NO, quantity) values('one', 1, 1);
...
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_NO, ORDERS_NO, PRODUCT_NO, ORDER_QUANTITY)
VALUES(10, (SELECT MAX(ORDERS_NO) FROM ORDERS), 1, 2);
